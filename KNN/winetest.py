...
plot_PCA(X_train, y_train, dataset.target_names, "Wizualizacja PCA - Zbiór Wine")
...
# Wizualizacja porównania dokładności, precyzji, recall i F1-score
